...
export function TermsContent() {
  return (
    <>
      <Text variant="title" style={s.title}>이용약관</Text>

      <Text variant="body" color={COLORS.secondary} style={s.section}>
        제1조 (목적){"\n\n"}
      ...
      <Text variant="body" color={COLORS.secondary} style={s.section}>
        ...
        2. 회원은 서비스를 이용하여 법령, 공서양속에 반하는 행위를 해서는 안 됩니다.{"\n"}
      ...
      <Text variant="caption" color={COLORS.muted} style={s.date}>
        시행일: 2026년 4월 5일
      </Text>
    </>
  );
...
const s = StyleSheet.create({
  ...
  section: { marginBottom: 24, lineHeight: 24 },
  date: { marginBottom: 32 },
});
